#load the hong kong mask generation script and shapefiles 
source("./mask_generation.R")

#direct loading of the dataset 
fname <- "./ENTLI.gdb.zip" 
...
#3. MC estimate using the updated distribution
library(MASS)
N=dim(beta.chain$beta)[1]
tf = 10 #sampling size to speed up predictions
